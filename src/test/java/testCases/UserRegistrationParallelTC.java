...
public class UserRegistrationParallelTC extends TestCaseBase2 {
	...
	public void userCanRegisterSuccessfully() {
		homeObject = new HomePO(getDriver());
		homeObject.openRegistrationPage();
		registerObject = new UserRegistrationPO(getDriver());
	...
	public void RegisteredUserCanLogin() {
		...
		loginObject=new LoginPO(getDriver());
